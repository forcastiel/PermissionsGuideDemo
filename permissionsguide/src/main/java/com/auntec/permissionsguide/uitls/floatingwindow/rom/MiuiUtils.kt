...
import com.auntec.permissionsguide.uitls.floatingwindow.rom.RomUtils.getSystemProperty
        ...
        get() {
            ...
            if (version != null) {
                try {
                    ...
                    Log.e(
                        TAG,
                        "get miui version code error, version : $version"
                    )
    ...
    private fun checkOp(context: Context, op: Int): Boolean {
        ...
        if (version >= 19) {
            ...
            try {
                ...
                var result = method.invoke(manager, op, Binder.getCallingUid(), context.packageName) as Int
//                Log.e("ttt", "result===>$result, 悬浮窗===>${AppOpsManager.MODE_ALLOWED == result || AppOpsManager.MODE_IGNORED == result}")
                return AppOpsManager.MODE_ALLOWED == result || AppOpsManager.MODE_IGNORED == result
            } catch (e: Exception) {
                Log.e(TAG, Log.getStackTraceString(e))
            }
        } else {
