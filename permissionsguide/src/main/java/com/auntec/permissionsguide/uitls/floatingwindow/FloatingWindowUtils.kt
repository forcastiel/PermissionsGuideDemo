...
import com.auntec.permissionsguide.uitls.floatingwindow.rom.*
...
object FloatingWindowUtils {
    ...
    fun requestPermission(activity: Activity, onPermissionResult: OnPermissionResult) =
        PermissionFragment.requestPermission(activity, 0, onPermissionResult)
