...
object RomUtils {
    ...
    fun checkIsHuaweiRom() = Build.MANUFACTURER.toLowerCase().contains("huawei")
    ...
    fun checkIs360Rom(): Boolean = Build.MANUFACTURER.contains("QiKU") || Build.MANUFACTURER.contains("360")

    fun checkIsOppoRom() = Build.MANUFACTURER.toLowerCase().contains("oppo")

    fun checkIsVivoRom() = Build.MANUFACTURER.toLowerCase().contains("vivo")

    fun checkIsSamSungRom() = Build.MANUFACTURER.toLowerCase().contains("samsung")
